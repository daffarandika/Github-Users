...
class GithubUserAdapterGrid(
    val githubUsers: List<GithubUser>,
    val context: Context
): RecyclerView.Adapter<GithubUserAdapterGrid.GViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_github_user_grid, parent, false)
